                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="/register">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="email" aria-describedby="emailHelp" name="email" placeholder="Enter l'adresse mail" />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputPassword">Mot de passe</label>
                                                        <input class="form-control py-4" id="inputPassword" type="password" placeholder="Enter le mot de passe" name="password" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="/login">vous avez un compte? Allez à login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
